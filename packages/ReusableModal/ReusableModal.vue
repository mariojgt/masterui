    ...
    <TransitionRoot appear :show="show" as="template">
        <Dialog as="div" @close="emitClose" class="relative z-10">
            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0" enter-to="opacity-100"
                ...
                <div class="fixed inset-0 bg-black/25 sm:bg-black/25" />
            </TransitionChild>

            <div class="fixed inset-0 overflow-y-auto">
                <div class="flex min-h-full sm:items-center sm:justify-center sm:p-4 text-center">
                    <TransitionChild as="template"
                        ...
                        :class="[
                            ...
                            <button v-if="showHeader" @click="emitClose"
                            ...
                            <div class="p-6 sm:p-0">
                                <slot v-if="showHeader" name="title">
                                    <h3 class="text-2xl font-semibold text-white sm:text-gray-900 dark:sm:text-white mb-8">
                                        Sign in
                                    </h3>
                                </slot>
                                <div class="mt-2">
                                ...
                                <div class="py-3 sm:flex sm:flex-row-reverse gap-4" v-if="showFooter">
                                    <button @click="emitConfirm" type="button" class="btn btn-success w-full sm:w-auto">
                                        {{ props.confirmText }}
                                    </button>
                                    <button @click="emitClose" type="button" class="btn btn-error w-full sm:w-auto">
                                        {{ props.cancelText }}
                                    </button>
                                </div>
                            </div>
